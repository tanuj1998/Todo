	...
	var BackgroundImage = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('img', { className: 'bg', src: 'https://source.unsplash.com/' + this.state.x + 'x' + this.state.y + '/?nature' })
	    );
	  }
	});

	ReactDOM.render(React.createElement(BackgroundImage, null), document.getElementById('app'));
